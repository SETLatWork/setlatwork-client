...
logging.basicConfig(format=format, level=logging.DEBUG, filemode='w', filename=r'{0}/logs/client.log'.format(basedir, datetime.datetime.now().strftime("%Y%m%d")), datefmt=datefmt)
os.chdir(basedir)
